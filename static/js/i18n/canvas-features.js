(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.engineRh": { zh: "工作流", en: "Workflow" },
        ...
        "smart.createGenerationNode": { zh: "生成节点", en: "Generation Node" },
        "smart.createGenerationNodeSub": { zh: "支持图片/音频/视频/批量上传", en: "Images, audio, video, batch upload" },
        ...
        "smart.createLoopSub": { zh: "控制链路运行轮数和批次", en: "Control chain run rounds and batches" },
        ...
        "smart.rhConfig": { zh: "工作流配置", en: "Workflow Config" },
        "smart.rhNoConfig": { zh: "暂无工作流配置", en: "No workflow config" },
        "smart.rhMachine": { zh: "显存", en: "VRAM" },
        "smart.rhNoParams": { zh: "暂无可调参数", en: "No adjustable params" },
        "smart.rhNeedConfig": { zh: "请先在 API 设置里添加并保存工作流", en: "Add and save a workflow in API Settings first" },
        "smart.rhNeedFields": { zh: "请先在 API 设置里编辑并保存这个应用参数", en: "Edit and save this app config in API Settings first" },
        "smart.rhUploadFailed": { zh: "工作流素材上传失败", en: "Workflow asset upload failed" },
        "smart.rhFailed": { zh: "工作流任务失败", en: "Workflow task failed" },
        "smart.rhNoTaskId": { zh: "工作流没有返回 taskId", en: "Workflow did not return a taskId" },
        "smart.rhTimeout": { zh: "工作流任务超时", en: "Workflow task timed out" },
        "smart.rhOutputsEmpty": { zh: "工作流没有返回产物", en: "Workflow returned no outputs" },
        "smart.videoDuration": { zh: "时长", en: "Duration" },
        "smart.videoDurationTip": { zh: "时长（秒）", en: "Duration (seconds)" },
        "smart.videoModelSelect": { zh: "模型选择", en: "Model Selection" },
        "smart.videoGenerationConfig": { zh: "生成配置", en: "Generation Settings" },
        "smart.videoGenerationMode": { zh: "生成方式", en: "Generation Mode" },
        "smart.videoAspect": { zh: "画面比例", en: "Aspect" },
        "smart.videoResolution": { zh: "清晰度", en: "Quality" },
        ...
        "smart.promptPlaceholderNode": { zh: "双击输入提示词...", en: "Double-click to enter prompt..." },
        ...
        "smart.promptExpandInstruction": { zh: "输入要扩写的提示词内容", en: "Enter the prompt content to enhance" },
        ...
        "smart.loopRunDone": { zh: "链路运行完成", en: "Chain run complete" },
        ...
        "smart.assetWorkflows": { zh: "模板", en: "Templates" },
        ...
        "smart.assetWorkflowEmpty": { zh: "模板资产先预留在这里，后续接入。", en: "Template assets are reserved here for a later step." },
        ...
        "smart.shortcutDuplicate": { zh: "拖拽时复制节点", en: "Duplicate node while dragging" },
        "smart.shortcutPreview": { zh: "打开图片或视频预览", en: "Open image or video preview" },
        "smart.shortcutPreviewNav": { zh: "切换图片或视频帧", en: "Switch images or video frames" },
        "smart.shortcutClosePanels": { zh: "关闭预览窗口", en: "Close the preview window" },
        "smart.shortcutGroup": { zh: "将选中节点打组", en: "Group selected nodes" },
        "smart.shortcutUngroup": { zh: "释放选中的分组", en: "Ungroup selected nodes" },
